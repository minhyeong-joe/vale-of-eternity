...
const mockRooms: Room[] = [
    { id: 1, name: "Dragon's Keep",   host: "Aelindra", players: 2, maxPlayers: 4, status: "waiting",     isLocked: false },
    { id: 2, name: "Shadow Realm",    host: "Thorin",   players: 3, maxPlayers: 4, status: "waiting",     isLocked: true  },
    { id: 3, name: "Ember Throne",    host: "Mystica",  players: 4, maxPlayers: 4, status: "in-progress", isLocked: false },
    { id: 4, name: "Iron Citadel",    host: "Valgor",   players: 1, maxPlayers: 4, status: "waiting",     isLocked: true  },
    { id: 5, name: "Whisper Peaks",   host: "Seraph",   players: 2, maxPlayers: 4, status: "waiting",     isLocked: false },
    { id: 6, name: "Ashen Wastes",    host: "Drevax",   players: 3, maxPlayers: 4, status: "in-progress", isLocked: true  },
];
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-b border-slate-600">
                                            <th className="text-left text-slate-400 text-xs font-semibold uppercase tracking-wide pb-3 pr-4">Room</th>
                                            ...
                                            filteredRooms.map((room) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {/* Host */}
                                                        <td className="py-3.5 pr-4">
                                                            <span className="text-slate-300 text-sm">{room.host}</span>
                                                        </td>
